...
export default function SingleAthlete() {
  ...
  if (!athlete)
    return (
      <div className="container my-5 text-center">Atleta non trovato.</div>
    );

  const totals = athlete.disciplines.reduce(
    (acc, d) => {
      ...
      <div className="row g-5">
            ...
            <div className="card-body text-center p-4">
              ...
              <div className="row text-center g-2">
                ...
                <div className="col-4">
                  ...
                  <div className="h5 fw-bold" style={{ color: "#CD7F32" }}>
                    {totals.bronze}
                  </div>
                </div>
              </div>
        ...
        <div className="col-lg-8">
          <div className="mb-5">
            ...
            >
              {athlete.bio ||
                "Nessuna biografia disponibile per questo atleta."}
            </p>
          </div>
                    ...
                    <div className="text-end">
                      {d.pivot.medal_type !== "none" ? (
                        <div className="d-flex align-items-center gap-2">
                          <i
                            className={`bi bi-trophy-fill fs-4 ${styles[d.pivot.medal_type + "Icon"]}`}
                          ></i>
                        </div>
                      ) : (
